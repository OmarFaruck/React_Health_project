...
import img2 from '../../images/person/person_2.jpg'
                ...
                <Card.Body>
                    ...
                    <Row>
                            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                <img src={img2} alt="" className="img-fluid mx-auto d-block personal" />
                            </div>  
                                <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-12">
                                    <p className='text'>Roger Adams</p>
                                </div>
                                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-12">
                                    <p className='texts'> 4 week ago</p>
                                </div>
                        </Row>
                </Card.Body>
            </Card>
